...
class Command(BaseCommand):
    ...
    given that no clashing occurs with the existing Variable objects.
    ...
    def handle(self, *args, **options):
        ...
        if vars_added:
            self.stdout.write(self.style.SUCCESS('The following variables have been loaded: '), ending='')
        ...
        sys_vars_in_db = Variable.objects.filter(type=Variable.SYSTEM_DEFINED)
